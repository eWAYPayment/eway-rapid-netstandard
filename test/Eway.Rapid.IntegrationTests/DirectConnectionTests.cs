...
namespace Eway.Rapid.IntegrationTests
{
    ...
    public class DirectConnectionTests
    {
        ...
        public async Task AuthorisationTransaction_Test()
        {
            ...
            Assert.Equal("CreditCard", response.PaymentInstrument.PaymentType);
            AssertHelper.Assert_ThreeDSecureAuth(request.PaymentInstrument.ThreeDSecureAuth, response.PaymentInstrument.ThreeDSecureAuth);
        ...
        public async Task GetAccessCodeResult_Test()
        {
            ...
            Assert.Equal("None", response.PaymentInstrument.PaymentType);
            Assert.NotNull(response.Customer.CardDetails);
        }
        ...
        public async Task QueryTransactionByTransactionId_Test()
        {
            ...
            Assert.Equal("CreditCard", response.Transactions.First().PaymentInstrument.PaymentType);
            Assert.NotNull(response.Transactions.First().Customer.CardDetails);
        }
